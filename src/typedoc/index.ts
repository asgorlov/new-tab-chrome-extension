...
export { default as SettingsHeaderContainer } from "../components/settings-menu/settings-header/settings-header.container";
export { default as SettingsHeaderComponent } from "../components/settings-menu/settings-header/settings-header.component";
export { type SettingsHeaderComponentProps } from "../components/settings-menu/settings-header/settings-header.component";
