...
import {loadDataFromStorage, offCheckbox, onCheckbox, selectDarkMode, setDataToStorage} from "../store/dark-mode.slice";
...
const NewTabContainer: FC = () => {
    ...
    const checkboxChangeHandler = useCallback(
        (e: ChangeEvent<HTMLInputElement>) => {
            ...
            dispatch(setDataToStorage({isDarkMode: e.target.checked}));
        }, [dispatch]
    );
